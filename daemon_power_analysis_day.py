...
while True:
    ...
    while cursor.alive:
        try:
            ...
            aggr_data = pad.mdb_get_energy_counter_data_grouped(job_input)#pad.mdb_get_energy_counter_data_new(job_input) #
            # Fetch the base load values
            base_values = base.get_base_load_values(job_input)
            # Calculate the averages
            hub_aggr = pad.pad.get_energy_counter_aggregate(aggr_data, base_values)#get_energy_counter_aggregate_new(aggr_data, base_values) #
